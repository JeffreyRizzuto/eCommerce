...
function createProdThumb($book)
{
	...
	<div class='col-sm-4 col-lg-4 col-md-4'>
		<div class='thumbnail'>
		    <a href='product_page.php?isbn=$isbn'><img src='$pic' alt='' style='width: 160px; height: 150px;'></a>
		    <div class='caption'>
			<h4 class='pull-right'>$$price</h4>
			<h4><a alt='$title' href='product_page.php?isbn=$isbn' >$thisTitle</a>
			</h4>
...
function fetchEUserDetails($username)
{
	...
	if($stmt->fetch()) {
		$row = array('uid' => $uid, 'username' => $uname, 'email' => $email, 'fname' => $fname, 'lname' => $lname, 'cur_address_st' => $cas,' cur_address_no' => $can, 'cur_address_c' => $cac, 'cur_address_state' => $cast, 'cur_address_zip' => $caz, 'phone_num' => $pn,'bil_address_st' => $bas, 'bil_address_no' => $ban, 'bil_address_c' => $bac, 'bil_address_state' => $bast, 'bil_address_z' => $baz);
	} else {
		echo "DATABASE ERROR OMG WTF!";
	}
	$stmt->close();
